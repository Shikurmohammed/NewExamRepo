...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('APP_NAME', 'AwashExam-backup'),
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    base_path(),//Comment this line to exclude files and backup database solely
                ],
                ...
                'exclude' => [
                    ...
                    storage_path('app/AwashExam-backup'),
                ],
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => 'shakirmoha5496@gmail.com',

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'shakirmoha5496@gmail.com'),
    ...
    'dump' => [
        'dump_binary_path' => env('MYSQL_DUMP_PATH', ''), // Path to mysqldump
