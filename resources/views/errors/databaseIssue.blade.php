        ...
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="flex items-center pt-8 sm:justify-start sm:pt-0">
                ...
                <div class="text-red-400">
                    <h1 class="text-red-400" style="color:red">Oops!</h1>
                    <p class="text-red-400" style="color:red">
                        {{ __('We are experiencing technical difficulties. Please try again later.') }}</p>
