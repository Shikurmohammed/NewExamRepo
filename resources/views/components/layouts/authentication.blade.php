    ...
    <main class="bg-white dark:bg-gray-900">
        ...
        <div class="relative flex">
                ...
                <div class="min-h-[100dvh] h-full flex flex-col after:flex-1">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
                            <!-- Logo -->
                            <a wire:navigate class="block" href="{{ route('examinee.dashboard') }}">
                                ...
                                <img src="{{ asset('images/awash_logo1.png') }}" alt="Awash Exam" width="100"
            ...
            {{-- <div class="absolute top-0 bottom-0 right-0 hidden md:block md:w-1/2" aria-hidden="true">
                    <img class="object-cover object-center w-full h-full" src="{{ asset('images/user-avatar-32.png') }}" width="760" height="1024" alt="Authentication image" />
                </div> --}}
