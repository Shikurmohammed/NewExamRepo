<div x-data="{ isOpen: @entangle('isModalOpen') }" id="create_test_modal" class="relative z-60">
    ...
    <div x-show="isOpen" class="fixed inset-0 z-50 flex items-center justify-center w-full h-full bg-black bg-opacity-50"
        ...
        <div class="w-full max-w-4xl p-6 mx-4 bg-white rounded-lg shadow-lg" x-show.transition.opacity="isOpen">
            <h2 class="mb-4 text-xl font-semibold">Create Test</h2>
            <form wire:submit.prevent="create" class="w-full p-6 bg-white rounded-lg shadow-md">
                <!-- First Row -->
                ...
                <div class="grid grid-cols-1 gap-4 mb-2 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" wire:model="mcma_partial_score"
                            class="w-5 h-5 text-blue-600 form-checkbox">
                        <label class="ml-2 text-sm text-gray-700">Partial Score for MCMA</label>
                    </div>
                    <div class="flex items-center">
                        <input type="checkbox" wire:model="noanswer_enabled"
                            class="w-5 h-5 text-blue-600 form-checkbox">
                        <label class="ml-2 text-sm text-gray-700">No Answer Option</label>
                    </div>
                    <div class="flex items-center">
                        <input type="checkbox" wire:model="comment_enabled"
                            class="w-5 h-5 text-blue-600 form-checkbox">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" wire:model="result_to_user"
                            class="w-5 h-5 text-blue-600 form-checkbox">
...
<script>
    ...
    function initializeSelect2() {
        $('#group_id').select2({
            dropdownParent: $('#create_test_modal'), // Ensure dropdown is attached to the modal
            width: '100%',
