<div>
    <input type="checkbox" name="light-switch" id="light-switch" class="light-switch sr-only" onclick=" toggleTheme()" />
    <label
...
<script>
    ...
    function toggleTheme() {
        console.log("theme switched:", localStorage.getItem('dark-mode'))
