...
class QuestionAssignmentModal extends Modal
{
    ...
    {
        return view('livewire.exams.question-assignment-modal');
    }
    public $topic_ids = [];
    public $test_id;
    public $question_ids = [];
    ...
    public function questions()
    {
        ...
        if (!$this->topic_ids) {
            ...
            $questions = Question::latest()->where('topic_id', 'Like', "%{$this->topic_ids}%")->paginate(4);
        }
        return   $questions;
    }
    #[Computed()]
    ...
    public function assignQuestion()
    {
        ...
        $this->dispatch('questionAssigned', $this->selectedQuestionType);
        try {
