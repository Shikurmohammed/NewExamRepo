                        ...
                        <tr>
                            <td class="p-2">
                                <div class="flex items-center">
                                    <div class="text-gray-800 dark:text-gray-100">{{ $group->id }}</div>
                                </div>
                            </td>
                            <td class="p-2">
                                <div class="text-center text-green-300">{{ $group->name }}</div>
                            </td>


                            <td class="p-2">
                                <div class="text-center text-sky-500">
                                    <a href="{{ url('edit_category', $group->id) }}"><i class="fas fa-edit"
                                            style="color:cyan">Edit</i></a>
                                    <a id="{{ $group->id }}" onclick="confirmDelete(event)" style="cursor: pointer;">
