<div class="z-10">
    <div class="p-4 bg-blue-600 rounded-t-lg">
        <h2 class="text-lg font-semibold text-white">Topic Details</h2>
    </div>
    <div class="p-6">
        ...
        <div class="space-y-4">
            <div>
                ...
                <span class="mt-1 text-sm text-gray-900">{{ $topic->module->name }}</span>
            </div>
            <div>
                <label class="text-sm font-semibold text-gray-700">Name:</label>
                <span class="mt-1 text-sm text-gray-900">{{ $topic->name }}</span>
            </div>
            <div>
                <label class="text-sm font-semibold text-gray-700 ">Description:</label>
                <span class="mt-1 text-sm text-gray-900">{{ $topic->description }}</span>
            </div>
            <div>
                <label class="text-sm font-semibold text-gray-700 ">Status:</label>
                <span class="mt-1 text-sm text-gray-900">
                    {{ $topic->enabled ? 'Enabled' : 'Inactive' }}
                </span>
            </div>
        </div>
